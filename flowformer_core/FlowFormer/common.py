...
from flowformer_core.utils.utils import bilinear_sampler, indexing
...
def nerf_encoding(x, L=6, NORMALIZE_FACOR=1 / 300):
    ...
    return torch.cat([x * NORMALIZE_FACOR, torch.sin(3.14 * x[..., -2:-1] * freq_bands * NORMALIZE_FACOR), torch.cos(3.14 * x[..., -2:-1] * freq_bands * NORMALIZE_FACOR), torch.sin(3.14 * x[..., -1:] * freq_bands * NORMALIZE_FACOR),
